...
export default function Auctionsbide() {
            ...
            try {
                ...
                if (value_price <= 0) {
                    ...
                    let highestBidderMapping = await nftContractOf.methods
                        ...
                        highestBidderMapping=highestBidderMapping.amount

                        
                    console.log("getItemId", highestBidderMapping);
    ...
    const userdata = async () => {
        ...
        try {
            ...
            highestBidderMapping=highestBidderMapping.amount;
            highestBidderMapping=web3.utils.fromWei(highestBidderMapping);
